...
```text
生成一张2:3竖版城市慢生活海报。奶油纸背景，下半部为一把钴蓝折叠椅和一株斜伸入画的橄榄枝，午后自然光形成柔和长影，呈现真实布料纹理。上方大标题严格写“把周末还给自己”，下方小字“坐一会儿，也很好”，底部仅“慢慢生活”。中文采用清楚的现代黑体，标点完整，行距宽松，不加入英文、日期、地址或品牌。保持椅子结构可信。后续只把椅子布面改为铁锈色，文字、橄榄枝和光线保持不变。
```
