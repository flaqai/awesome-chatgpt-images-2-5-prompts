# Prompt per ChatGPT Images 2.5 — flaq.ai

Un progetto open source indipendente creato e mantenuto dal team di [flaq.ai](https://flaq.ai), per foto di prodotti, ritocchi mirati, ritratti, pubblicità, infografiche e storyboard.
...
[flaq.ai](https://flaq.ai) offre un’API unificata per modelli di immagini, video, musica e linguaggio, destinata a chi sviluppa agenti IA e applicazioni. Il team pubblica questa raccolta per condividere prompt riutilizzabili e osservazioni sui risultati dei processi creativi.

I link Flaq.ai qui sotto riguardano GPT Image 2. Per Images 2.5 direttamente su OpenAI, consulta la [guida API](docs/api-guide.md).
