# Prompts ChatGPT Images 2.5 — par flaq.ai

Un projet indépendant et open source créé et maintenu par l’équipe [flaq.ai](https://flaq.ai). Il couvre les images produit, les retouches ciblées, les portraits, les animaux, les affiches, les récits illustrés et le design multilingue.
...
103 recettes : 73 briefs complets en anglais et en chinois simplifié, plus 12 recettes propres à différentes langues. 139 images ont été nouvellement générées. Cette page est une introduction en français, pas la traduction intégrale de la bibliothèque. S’y ajoutent 18 nouvelles recettes de workflow disponibles uniquement en anglais.


**[Galerie des 103 recettes illustrées](docs/gallery.md)**
...
[flaq.ai](https://flaq.ai) propose une API unifiée pour les modèles d’image, de vidéo, de musique et de langage, destinée aux développeurs d’agents IA et d’applications. L’équipe publie cette bibliothèque pour partager des prompts réutilisables, des exemples originaux et des observations sur les résultats.

Les liens Flaq.ai ci-dessous concernent GPT Image 2. Pour utiliser Images 2.5 directement avec OpenAI, consultez le [guide API](docs/api-guide.md).
