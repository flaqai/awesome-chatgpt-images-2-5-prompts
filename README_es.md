# Prompts de ChatGPT Images 2.5 — por flaq.ai

Proyecto independiente de código abierto creado y mantenido por el equipo de [flaq.ai](https://flaq.ai). Incluye fotografía de producto, edición precisa, retratos, mascotas, anuncios, historias y diseño multilingüe.
...
[flaq.ai](https://flaq.ai) ofrece una API unificada para modelos de imagen, vídeo, música y lenguaje, dirigida a quienes desarrollan agentes de IA y aplicaciones. El equipo publica esta biblioteca para compartir prompts reutilizables, ejemplos originales y observaciones sobre los resultados.
